"""
Apex Bank legacy positions extract — Parquet, ISIN + asset-class codes, CHF valuation.
"""
...
_AC_CODE = {"equity": "EQ", "fixed_income": "FI", "fund": "FD",
            "structured": "ST", "alternative": "ALT", "cash": "SummitH", "fx": "FX"}


def write(clients_m, out_dir: str) -> dict:
    path = os.path.join(out_dir, "apex_positions.parquet")
